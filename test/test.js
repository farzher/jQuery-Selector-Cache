...
$(function() {
	...
	test('clear', function() {
		...
		deepEqual($$('#testContext div', 'clear').length, 0, 'The return value from clear should be what was in the cache');
	...
	test('fresh', function() {
		...
		deepEqual($$('#testContext div', 'fresh').length, 0, 'Doing a fresh call should find nothing');
	});
});